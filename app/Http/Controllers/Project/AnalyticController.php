...
class AnalyticController extends Controller
{
    ...
    public function leadAndCycleTime()
    {
        ...
        $this->response->html($this->helper->layout->analytic('project/analytic/lead_cycle_time', [
            'values' => [
                'from' => $from,
                'to'   => $to,
            ],
    ...
    public function timeComparison()
    {
        ...
        $this->response->html($this->helper->layout->analytic('project/analytic/time_comparison', [
            'project'   => $project,
            'paginator' => $paginator,
    ...
    public function averageTimeByColumn()
    {
        ...
        $this->response->html($this->helper->layout->analytic('project/analytic/avg_time_columns', [
            'project' => $project,
    ...
    public function taskDistribution()
    {
        ...
        $this->response->html($this->helper->layout->analytic('project/analytic/task_distribution', [
            'project' => $project,
    ...
    public function userDistribution()
    {
        ...
        $this->response->html($this->helper->layout->analytic('project/analytic/user_distribution', [
            'project' => $project,
    ...
    public function cfd()
    {
        $this->commonAggregateMetrics('project/analytic/cfd', 'total', t('Cumulative flow diagram'));
    }
    ...
    {
        $this->commonAggregateMetrics('project/analytic/burndown', 'score', t('Burndown chart'));
    }
