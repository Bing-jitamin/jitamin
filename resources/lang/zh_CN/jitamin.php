...
return [
    ...
    'Finish this task' => '完成该任务',
    'There is no description.' => '当前没有描述。',
    'Add a new task' => '创建新任务',
    ...
    'Comment added successfully.' => '评论成功。',
    ...
    'Sub-task added successfully.' => '成功创建子任务',
    'Maximum size: ' => '大小上限：',
    ...
    'view the task on Jitamin' => '在Jitamin中查看此任务',
    'Public access' => '公开访问',
    'Active tasks' => '已激活的任务',
    ...
    'Move the task to another project' => '任务移动到其它项目',
    ...
    'Percentage' => '百分比',
    'Number of tasks' => '任务数',
    'Number of times' => '工时数（日）',
    'Task distribution' => '任务分布',
    'Analytics' => '统计',
    'Subtask' => '子任务',
    'My subtasks' => '我的子任务',
    'User repartition' => '用户分析',
    'User time repartition' => '用户工时分析',
    ...
    'Active swimlanes' => '启用的泳道',
    'Add a new swimlane' => '创建新泳道',
    ...
    'Link added successfully.' => '成功创建关联。',
    ...
    'Move the task to another column when the category is changed' => '当任务分类改变时移动到指定栏目',
    'Move the task to another column when the progress is changed' => '当任务进度改变时移动到指定栏目',
    ...
    'Assign a priority when the task is moved to a specific swimlane' => '任务移动到指定泳道，设置优先级',
    'User unlocked successfully.' => '用户锁定成功',
    'Unable to unlock the user.' => '不能解锁该用户',
    'Move a task to another swimlane' => '任务移动到其他泳道中',
    'Creator Name' => '创建者',
    ...
    'Add a new project restriction' => '创建项目约束',
    'Add a new drag and drop restriction' => '创建拖拽约束',
    'Add a new column restriction' => '创建栏目约束',
    'Edit this role' => '编辑该角色',
    'Remove this role' => '删除该角色',
    'There is no restriction for this role.' => '该角色当前没有约束',
    ...
    'Closing or opening a task is blocked for this column' => '不允许在该栏目关闭或打开任务',
    'Task creation is not permitted' => '不允许创建项目',
    'Closing or opening a task is not permitted' => '不允许打开和关闭任务',
    'New drag and drop restriction for the role "%s"' => '为角色 "%s" 创建拖拽约束',
    'Remove a drag and drop restriction' => '删除拖拽约束',
    'People belonging to this role will be able to move tasks only between the source and the destination column.' => '属于该角色的用户只能在原栏目和目标栏目间移动',
    'Remove a column restriction' => '删除栏目约束',
    'Do you really want to remove this drag and drop restriction: "%s" to "%s"?' => '你确定要删除该拖拽约束: "%s" -> "%s"?',
    'New column restriction for the role "%s"' => '为角色 "%s" 创建栏目约束',
    'Rule' => '规则',
    'Do you really want to remove this column restriction?' => '你确定要删除该栏目约束?',
    'Custom roles' => '自定义角色',
    ...
    'New project restriction for the role "%s"' => '为角色 "%s" 创建项目约束',
    'Restriction' => '约束',
    'Remove a project restriction' => '删除项目约束',
    'Do you really want to remove this project restriction: "%s"?' => '你确定要删除该项目约束: "%s"',
    'Duplicate to multiple projects' => '复制到多个项目',
    'This field is required' => '该字段为必填项',
    'Moving a task is not permitted' => '不允许移动任务',
